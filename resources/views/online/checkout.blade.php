...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="alert alert-warning d-flex align-items-center shadow-sm" role="alert">
            ...
            <div>
                🚨 <strong>แจ้งเตือน:</strong> เมื่อทำการสั่งซื้อแล้ว
                <u>จะไม่สามารถยกเลิกเองได้ถ้าต้องการจะยกเลิกกรุณาติดต่อที่เบอร์ 084-386-0015</u>
            </div>
        </div>
        <div class="checkout-card">
            ...
            <form action="{{ route('online.online.checkout') }}" method="POST" enctype="multipart/form-data">
                ...
                <h5 class="mb-3">ยอดรวมทั้งหมด: <strong class="text-orange">{{ number_format($total, 2) }}</strong> บาท
                </h5>

                <div class="mb-3">
                    <label class="form-label">วิธีการชำระเงิน</label>
                    <select class="form-select" name="payment_method" required
                        onchange="showQRCode(this.value, {{ $total }})">
                ...
                <input type="hidden" name="order_token" value="{{ Str::uuid() }}">
                <button type="submit" id="submitBtn" class="btn btn-orange px-4 py-2">
