...
<div class="w-full min-h-screen px-6 py-8">
    ...
    <h2 class="text-3xl font-semibold text-gray-800 flex items-center gap-2 whitespace-nowrap mb-4">
                ...
                <td class="px-4 py-3 text-center">
                    @if ($product->is_active)
                        <span class="inline-flex items-center gap-1 bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full">
                            <span class="w-2 h-2 bg-green-500 rounded-full"></span> ใช้งาน
                        </span>
                    @else
                        <span class="inline-flex items-center gap-1 bg-gray-200 text-gray-600 text-xs font-semibold px-3 py-1 rounded-full">
                            <span class="w-2 h-2 bg-gray-500 rounded-full"></span> ไม่ใช้งาน
                        </span>
                    @endif
                </td>
            </tr>
